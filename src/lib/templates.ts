 ...
 */
export function createTemplate(name: string, description: string, offenses: SelectedOffense[]): Template {
 ...
 */
export function importTemplateFromUrl(): { name: string; description: string; offenses: SelectedOffense[] } | null {
    const url = new URL(window.location.href);
